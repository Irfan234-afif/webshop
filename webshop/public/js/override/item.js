                ...
                let dialog = new frappe.ui.Dialog({
                    ...
                    fields: [
                        ...
                        },
                        {
                            ...
                            fieldtype: "Check",
                            label: __("Use Fixed Period"),
                            default: 0,
                            description: __("If checked, the subscription will end after the specified interval count."),
                        },
                         {
                            fieldtype: "Column Break",
                        },
                    ...
                    primary_action: function (values) {
                        ...
                        frappe.call({
                            ...
                            args: {
                                ...
                                use_fixed_period: values.use_fixed_period,
                            },
                            freeze: true,
