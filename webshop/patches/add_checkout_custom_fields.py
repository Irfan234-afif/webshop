...
"""
Patch to add checkout-related custom fields to Quotation and Sales Order
"""
...
def execute():
	"""
	Add custom fields for checkout flow to Quotation and Sales Order
	"""
	print("Adding checkout custom fields to Quotation and Sales Order...")
	...
	print("✓ Checkout custom fields added successfully")
