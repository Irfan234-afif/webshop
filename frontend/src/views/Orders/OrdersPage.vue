<template>
  <DefaultLayout>
    <Container class="py-6">
      ...
      <div class="mb-8 p-4 bg-gray-50 rounded-xl border border-gray-100 flex flex-wrap gap-4 items-center justify-between">
        <div class="flex flex-wrap gap-4 items-center w-full lg:w-auto">
          <!-- Student Filter -->
          <div class="relative min-w-[200px] bg-white border border-gray-200 rounded-lg px-3 py-2 flex items-center gap-3">
          ...
          <!-- Status Filter -->
           <div v-if="activeTab === 'orders'" class="relative min-w-[200px] bg-white border border-gray-200 rounded-lg px-3 py-2 flex items-center gap-3">
      ...
      />
        ...
        <div ref="infiniteScrollTrigger" class="flex justify-center p-6 h-20 opacity-0">
             <div v-if="ordersResource.loading" class="animate-spin rounded-full h-8 w-8 border-b-2 border-primary opacity-100"></div>
        </div>

       <!-- Promotional Banner -->
      <div
        class="relative bg-gradient-to-r from-purple-700 to-purple-900 rounded-2xl overflow-hidden mb-12"
      >
      ...
      <OrderDetailModal
        ...
        @back-to-payment-method="handleBackToPaymentMethod"
      />
    </Container>
  </DefaultLayout>
</template>
