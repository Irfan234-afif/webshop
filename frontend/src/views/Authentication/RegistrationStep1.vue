  ...
  <div>
    ...
    <form @submit.prevent="handleNext">
      ...
      <button
        ...
        class="w-full bg-gray-700 text-white font-bold py-4 px-6 rounded-xl hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
        Isi Data Siswa
      </button>
    </form>
