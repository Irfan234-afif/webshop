    ...
    <Container class="flex flex-col gap-17">
      ...
      <div class="flex items-center justify-between gap-17 mb-16">
        ...
        <div class="flex items-center gap-4">
          <!-- Left Arrow -->
          <button
            class="w-12 h-12 rounded-full overflow-hidden flex items-center justify-center transition-colors"
            :class="
              isAtStart
      ...
      <div
        ref="scrollContainer"
        class="flex items-stretch gap-4 overflow-x-auto overflow-y-visible scrollbar-hide"
      ...
      >
        ...
        >
          <ProductCard
            ...
            :price="product.price"
            :original-price-range="product.originalPriceRange"
            :discount="product.discount"
            :has-discount="product.hasDiscount"
            :is-in-wishlist="wishlistStore.isInWishlist(product.itemCode)"
        ...
        >
          ...
          <div class="flex flex-col gap-12">
            <div class="flex flex-col gap-6 capitalize whitespace-pre-wrap">
              <h3
                class="font-bold text-xl leading-tight text-white"
            ...
            <!-- CTA Button -->
            <button
              class="flex items-center gap-3 h-8 justify-start pt-4 hover:underline transition-all group"
            >
              <span
