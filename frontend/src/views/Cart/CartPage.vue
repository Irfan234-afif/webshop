        ...
        <div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-4">
              <!-- Empty Cart State -->
              <div
                v-if="cartStore.selectedStudentCart?.items.length === 0"
              ...
              <!-- Student Cart Groups -->
              <div
                v-for="student in cartStore.studentCarts"
                :key="student.name"
                class="bg-white rounded-lg border border-gray-200 overflow-hidden"
              >
                <!-- Student Cart Header -->
                <button
                  @click="toggleStudentCart(student.name)"
                  class="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors"
                >
                  <div class="flex items-center gap-3">
                    <input
                      type="checkbox"
                      :checked="isStudentSelected(student.name)"
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <svg
                      ...
                      :class="{ 'rotate-180': studentCartsExpanded[student.name] }"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <div
                  v-if="studentCartsExpanded[student.name]"
                  class="border-t border-gray-200 p-4 space-y-3"
                >
                  <CartItem
                    v-for="item in student.items"
                    :key="item.id"
                    :item="item"
                    :quotation_name="student.quotation_name"
            ...
            <div class="lg:col-span-1">
              <CartSummary
                :items="cartStore.selectedStudentCart ? cartStore.selectedStudentCart.items : []"
