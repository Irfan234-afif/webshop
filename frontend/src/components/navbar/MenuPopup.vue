...
const menuItems = ref<MenuItem[]>([
  { id: 'orders', label: 'Pesanan', icon: 'bill', badge: 3, link: '/orders' },
  { id: 'products', label: 'Produk', icon: 'uniform', link: '/products' },
  { id: 'wishlist', label: 'Wishlist', icon: 'wishlist', link: '/wishlist' },
  { id: 'contact', label: 'Kontak', icon: 'info', link: '#' },
  { id: 'cart', label: 'Keranjang', icon: 'cart', badge: 10, link: '/cart' },
  { id: 'bills', label: 'Tagihan', icon: 'bill-list', badge: 2, link: '/bills' },
  { id: 'help', label: 'Bantuan', icon: 'info', link: '/help' },
  { id: 'account', label: 'Pengaturan Akun & Data Siswa', icon: 'user-circle', link: '/account' },
    ...
    <div class="bg-white flex flex-col p-8 border-b-[1.5px] border-[rgba(30,30,30,0.1)]">
      <div class="flex flex-col">
        ...
        >
          ...
          <CheckCircleIcon
            :filled="student.name === activeStudent"
            class="w-6 h-6"
          />
        </button>
      </div>
        ...
        <template v-for="(item, index) in menuItems">
          ...
          >
            ...
            <div class="flex gap-6 items-center">
              <div
                v-if="item.badge"
                class="bg-[#8dc73c] rounded-full w-6 h-6 flex items-center justify-center"
              >
