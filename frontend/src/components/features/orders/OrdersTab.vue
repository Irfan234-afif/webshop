<template>
  <div>
    ...
    <div v-else-if="!loading" class="text-center py-12">
      ...
      <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada pesanan aktif</h3>
      <p class="text-gray-500 mb-6">Pesanan yang sedang diproses akan muncul di sini</p>
      <RouterLink
        to="/products"
