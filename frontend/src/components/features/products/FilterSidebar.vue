...
<template>
  ...
  >
    <!-- Header -->
    <div
      v-if="variant === 'default' || productsStore.hasActiveFilters"
    ...
    >
      ...
      <button
        v-if="productsStore.hasActiveFilters"
    ...
    <div class="flex flex-col gap-6 lg:gap-8">
      ...
      <FilterGroup
        title="Kategori"
        :options="productsStore.availableCategories"
        :selected="productsStore.activeFilters.categories"
      ...
      <FilterGroup
        title="Harga"
        :options="productsStore.availablePriceRanges"
        :selected="productsStore.activeFilters.priceRanges"
        @toggle="handleTogglePriceRange"
      />
    </div>
